...
object AllEvents {
	...
	// view
	const val E1_SCREEN_VIEW_HOME = "e1_screen_view_home"
	const val E1_SCREEN_VIEW_PDF = "e1_screen_view_pdf"
	const val E1_SCREEN_VIEW_WORD = "e1_screen_view_word"
	const val E1_SCREEN_VIEW_EXCEL = "e1_screen_view_excel"
	const val E1_SCREEN_VIEW_POWER_POINT = "e1_screen_view_power_point"
	const val E1_SCREEN_VIEW_TEXT = "e1_screen_view_txt"
	const val E1_SCREEN_VIEW_SETTING = "e1_screen_view_setting"
	const val E1_SCREEN_VIEW_POLICY = "e1_screen_view_policy"
	const val E1_SCREEN_VIEW_CHOOSE_LANGUAGE = "e1_screen_view_choose_language"
	const val E1_SCREEN_VIEW_SEARCH = "e1_screen_view_search"
	const val E1_SCREEN_VIEW_RECENT = "e1_screen_view_recent"
	const val E1_SCREEN_VIEW_FAVORITE = "e1_screen_view_favorite"
}