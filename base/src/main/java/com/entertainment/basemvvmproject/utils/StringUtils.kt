...
//        }
    ...
    fun getSpanName(nameMember: String, colorName: Int, context: Context): SpannableString {
        val span = SpannableString("$nameMember ")
        span.setSpan(
            ContextCompat.getColor(context, colorName),
            0,
            nameMember.length,
